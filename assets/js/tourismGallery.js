...
function refresh_cards() {
	fetch(base_url + "api/tourism/tourism_gallery")
			...
			if(response.length > 0){
				...
				<div class="col-lg-3 col-md-6">
					...
					content += `
						...
						<div class="row p-2">
							<a href="${base_url}tourism/editImage/${element.id_publicacion}" class="btn btn-warning mx-auto col-5">Editar</a>
...
function deleteImage() {
	Swal.fire({
		...
		if (result.value) {
			fetch(base_url + 'tourism/delete/' + this.value, {
				method: 'DELETE'
			})
				.then(() => {
					Swal.fire(
