...
function refresh_cards() {
	fetch(base_url + "api/tourism/tourism_wallpapers")
			...
			if(response.length > 0){
				...
				<div class="col-lg-3 col-md-6">
					<div class="card" style="height: 96%">
						<img class="card-img-top img-responsive" src="${element.recurso_av_1 ? base_url+'uploads/tourism/'+element.recurso_av_1 : base_url+'assets/images/default/no-image-available-icon.jpg'}" class="card-img-top" alt="...">
						<div class="card-body">
					...
					content += `
						...
						<div class="row p-2">
							<a href="${base_url}tourism/editWallpaper/${element.id_publicacion}" class="btn btn-warning mx-auto col-5">Editar</a>
...
function deleteImage() {
	Swal.fire({
		...
		if (result.value) {
			fetch(base_url + 'tourism/deleteWallpaper/' + this.value, {
				method: 'DELETE'
			})
				.then(() => {
					Swal.fire(
