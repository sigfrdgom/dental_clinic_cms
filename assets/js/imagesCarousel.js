			...
			if(response.length > 0){
				...
				<div class="col-lg-3 col-md-6">
					<div class="card" style="height: 96%">
						<img class="card-img-top img-responsive" src="${element.recurso_av_1 ? base_url+'uploads/thumbnails/inicio/'+element.recurso_av_1 : base_url+'assets/images/default/no-image-available-icon.jpg'}" class="card-img-top" alt="...">
						<div class="card-body">
