    ...
    <div class="card mb-3 form-shadow">
        <div class="row ">
            <div class="col-12 col-sm-6 col-md-3 col-lg-3 col-xl-2">
                <img src="<?= !empty(trim($service->recurso_av_1)) ? base_url("uploads/" . trim($service->recurso_av_1)) : base_url("assets/images/blog/blog.png") ?>" class="card-img" alt="Imagen de presentación">
            </div>
