...
foreach ($services as $service) {
    ...
    <tr>
        ...
        <td class="align-middle text-center"><?= $service->estado ? 'ACTIVO' : 'INACTIVO' ?></td>
        <td class="align-middle text-center"><img src="<?= $service->recurso_av_1 ? "uploads/" . $service->recurso_av_1 : './assets/images/default/no-image-visible.png' ?>" alt="" width="130"></td>
