...
foreach ($services as $service) {
    ...
    <tr>
        ...
        <td class="align-middle text-center"><?= $service->estado ? '<i class="fas fa-eye" style="font-size: 4em; color: #00aeef;"></i>' : '<i class="fas fa-eye-slash" style="font-size: 4em; color: gray;"></i>' ?></td>
