    ...
    <div class="card mb-3 form-shadow">
        <div class="row ">
            ...
            <div class="col-12 col-sm-6 col-md-5 col-lg-5 col-xl-6">
                <div class="card-body">
                    <h5 class="card-title"><?= $testimonial->titulo ?></h5>
                    <p class="card-text"><?= $testimonial->texto_introduccion ?></p>
                    <p class="card-text"><small class="text-muted"><?= $testimonial->fecha_ingreso ?></small></p>
                </div>
            </div>
