<div class="container-fluid">
    <div class="row page-titles pt-2 pb-0" style="background: white">
        <div class="col-md-5 align-self-center mb-2">
            <h4 class="text-themecolor text-dark float-left mt-2">TESTIMONIOS &nbsp; &nbsp;</h4>

            <a href="<?= base_url('testimonials/create') ?>" class="btn btn-outline-success btn-rounded">Agregar testimonios</a>

            <a href="#" title="Agregar testimonios" data-toggle="popover" data-trigger="focus" data-content="Sirve para agregar un nuevo publicación y su información">
