<div class="container-fluid">
    <div class="row page-titles pt-2 pb-0" style="background: white">
        <div class="col-md-5 align-self-center mb-2">
            <h4 class="text-themecolor text-dark float-left mt-2">Iconos de Servicios &nbsp; &nbsp;</h4>
            <a href="<?= base_url('homePage/createIcon') ?>" class="btn btn-outline-success btn-rounded">Agregar Icono</a>
        ...
        <div class="col-md-7 align-self-center text-right text-dark">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Iconos de Servicios</li>
                </ol>
            </div>
        </div>
    </div>
...
<script src="<?= base_url('assets/js/iconsServices.js') ?>"></script>