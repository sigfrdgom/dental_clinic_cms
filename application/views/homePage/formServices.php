...
<div class="card ">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?= isset($clasificationServices->titulo) ? $clasificationServices->titulo : '' ?>" name="titulo" id="" aria-describedby="helpId" maxlength="100" placeholder="Título de la Imágen">
        </div>

        <?php if (isset($clasificationServices->estado)) { ?>
            <div class="form-group mt-2">
                <label for="estado">Estado</label>
                <select name="estado" id="" class="form-control" required>
                    <option value="1" <?= ($clasificationServices->estado) ? 'selected' : '' ?>>Visible</option>
                    <option value="0" <?= ($clasificationServices->estado) ? '' : 'selected' ?>>Oculto</option>
                </select>
            </div>
        <?php } ?>
        ...
        <div class="form-group">
            ...
            <textarea name="contenido" id="editor" required><?= isset($clasificationServices->contenido) ? $clasificationServices->contenido : '' ?></textarea>
            <script>
