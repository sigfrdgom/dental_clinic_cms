<div class="container-fluid">
        ...
        <div class="col-md-7 align-self-center text-right text-dark">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Añadir imagen al Carrusel</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <form action="<?=  base_url('homePage/saveIconServices' )?>" method="post" enctype="multipart/form-data" class="col-12 col-sm-12 col-md-10 col-lg-8 mx-auto">
